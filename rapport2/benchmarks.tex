...
\begin{figure}[h!]
  \centering
  \missingfigure{Lav graf med performance af z-curve, tiled og row/column}
...
\begin{figure}[h!]
  \centering
  \missingfigure{Lav graf med cache faults for z-curve og tiled}
...
\begin{figure}[h!]
  \centering
  \missingfigure{Lav graf med instructions for z-curve og tiled}
