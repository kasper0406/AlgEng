...
For computing a cell in a matrix we exchanged the dot product loop such that it read, multiplied, and added four values each time.

For Strassen we also added AVX instructions for matrix additions ans substractions.
