...
plot 'rowcol.dat' using (log2($1)):($7) title "Time" axes x1y1 with linespoints, \
     'rowcol.dat' using (log2($1)):($11) title "L2 cache misses" axes x1y2 with linespoints, \
