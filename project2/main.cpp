...
typedef Matrix<ZCurveTiled<double, B, true>, HackyStrassen<B, FixedTiledBCMultiplier<B>>, false> ZRTHS;
typedef Matrix<ZCurveTiled<double, B, false>, HackyStrassen<B, FixedTiledBCMultiplier<B>>, false> ZCTHS;
