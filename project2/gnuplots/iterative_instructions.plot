...
set output "./iterative_instructions.pdf"
...
'../data/4096/row-tiled64x64 tiled-iterative(tiled-bc)_column-tiled-64x64 tiled-iterative(tiled-bc)_row-tiled64x64 tiled-iterative(tiled-bc)_0.dat' using (log2($1)):($14) title "Iterative, tiled, 64x64" axes x1y1 with linespoints